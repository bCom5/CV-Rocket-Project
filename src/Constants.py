...
# CLOSE FILTER
# LOCAL FILTER, NOT ON THE PI, DEPRECATED
	'minArea' : 5,
	'maxArea' : 20000,
	'minPerimeter' : 5,
	'maxPerimeter' : 3000,
...
# PI CAMERA FILTER
# PLEASE CHANGE ME AS SEEN FIT, SOME VALUES ARE CURRENTLY NOT SUPPORTED, LOOK AT FILTER.PY FOR ALL SUPPORTED AND UNSUPPORTED VALUES
# TO REINCORPORATE VALUES, MODIFY FILTER.PY:RUN
	'minArea' : 40,
	'maxArea' : 20000,
	'minPerimeter' : 5,
	'maxPerimeter' : 8000,
	...
	'maxRatioWidthtoSize' : 0.99,
	'minRatioHeighttoSize' : 0.001,
	'maxRatioHeighttoSize' : 0.99,
	'tolerance' : 24 # Number of above conditions to be met for successful contour observation
}
...
CONFIDENCE_WINDOW_WIDTH = 50 # Changing this value may cause problems in Filter.py, or in other confidence related scripts
CONFIDENCE_WINDOW_HEIGHT = 50 # Try and keep these to values to be the same value, but it should be fine regardless